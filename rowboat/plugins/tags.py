...
class TagsPlugin(Plugin):
    def load(self, ctx):
        ...
        self.remote_url = 'https://raw.githubusercontent.com/Xenthys/RawgoatTags/master/tags/{}.md'
    ...
    def on_tags_info(self, event, name):
        ...
        embed.add_field(name='Imported', inline=True, value='No' if not source else ('Yes: [{source}]'
            '(https://github.com/Xenthys/RawgoatTags/blob/master/tags/{source}.md)').format(source=source))
        ...
        if source:
            ...
            if r and content == r:
                return event.msg.reply(
                    ('This tag was imported from `{source}`: <https://github.com/Xenthys'
